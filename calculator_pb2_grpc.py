...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/Calculator/Add',
                request_serializer=calculator__pb2.operands.SerializeToString,
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=calculator__pb2.operands.FromString,
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/Add',
            calculator__pb2.operands.SerializeToString,
